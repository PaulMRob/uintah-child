...
class Carousel_Alt_Widget extends WP_Widget {

    public function __construct() {
        parent::__construct(
            'carousel_alt_widget',
            __('Carousel Alt', 'astra-child'),
            ['description' => __('Displays a customizable carousel of posts in scroll format', 'astra-child')]
        );
    }
    ...
    public function widget( $args, $instance ) {
        ...
        $title         = !empty($instance['title']) ? $instance['title'] : __('Carousel Alt', 'astra-child');
        ...
        echo '<div class="scroll-wrapper" data-scroll-speed="' . esc_attr($scroll_speed) . '" data-auto-scroll="' . esc_attr($auto_scroll) . '">';
        ...
        if ($carousel_query->have_posts()) :
            while ($carousel_query->have_posts()) : $carousel_query->the_post();
                ...
                <a href="<?php echo esc_url(get_permalink()); ?>" class="card-link">
                    <div class="carousel-alt-post-card"
...
add_action('widgets_init', function(){
    register_widget('Carousel_Alt_Widget');
});
